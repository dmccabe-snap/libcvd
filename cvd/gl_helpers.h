        ...
        while((code = glGetError()) != GL_NO_ERROR){
            switch (code) {
                case GL_INVALID_ENUM:
                    std::cout << "GL:GL_INVALID_ENUM" << std::endl;
                    break;
                case GL_INVALID_VALUE:
                    std::cout << "GL:GL_INVALID_VALUE" << std::endl;
                    break;
                case GL_INVALID_OPERATION:
                    std::cout << "GL:GL_INVALID_OPERATION" << std::endl;
                    break;
                case GL_INVALID_FRAMEBUFFER_OPERATION:
                    std::cout << "GL:GL_INVALID_FRAMEBUFFER_OPERATION" << std::endl;
                    break;
                case GL_OUT_OF_MEMORY:
                    std::cout << "GL:GL_OUT_OF_MEMORY" << std::endl;
                    break;
                case GL_STACK_UNDERFLOW:
                    std::cout << "GL:GL_STACK_UNDERFLOW" << std::endl;
                    break;
                case GL_STACK_OVERFLOW:
                    std::cout << "GL:GL_STACK_OVERFLOW" << std::endl;
                    break;
                default:
